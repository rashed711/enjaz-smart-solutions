...
function App() {
  ...
  const handleOrderPlan = (planName: string) => {
    ...
    // Ideally we would pre-fill the contact form message here, 
    // but for now we just scroll to contact
  };
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mb-4">اشترك ليصلك كل جديد في عالم التقنية.</p>
              <form onSubmit={(e) => e.preventDefault()} className="relative">
                <input type="email" placeholder="بريدك الإلكتروني" className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-primary-500 transition-colors" />
                <button type="submit" className="absolute left-2 top-1.5 bg-primary-600 text-white p-1.5 rounded-md hover:bg-primary-500 transition-colors">
